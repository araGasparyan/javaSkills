                	...
                	if(!pauseFlag)
                	{
	                    ...
	                    if (nBytesRead != -1)
	                    {
	                    	...
	                    	sourceLine.write(data, 0, nBytesRead);
                                ...
                                System.out.println(sourceLine.getLongFramePosition());
                                System.out.println(sourceLine.getFramePosition());
                                System.out.println(sourceLine.getMicrosecondPosition());
                                System.out.println((float)sourceLine.getLevel());
